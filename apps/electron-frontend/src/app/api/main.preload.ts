...
import { EditMainSettingValueResponse } from "@/shared/types/electron";
...
contextBridge.exposeInMainWorld("electron", {
  ...
  editMainSetting: <K extends keyof MainSettingsType>(args: {
    key: K;
    value: MainSettingsType[K];
  }): Promise<EditMainSettingValueResponse> => ipcRenderer.invoke("edit-main-setting-value", args),
});
